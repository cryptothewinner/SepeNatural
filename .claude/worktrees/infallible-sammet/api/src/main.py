...
def get_production_orders(tenant_id: str = Depends(get_tenant_id)):
    """Tüm üretim emirlerini ingestion servisinden getirir."""
    headers = {"X-Tenant-ID": tenant_id}
    try:
        resp = requests.get(f"{INGESTION_URL}/ingest/production-orders", headers=headers)
